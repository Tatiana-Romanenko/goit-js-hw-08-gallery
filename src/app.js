...
function onGalleryImageClick(event) {
  ...
  const modalImageSource = event.target.dataset.source;
const modalImageAlt = event.target.getAttribute('alt');
console.log(modalImageSource);
  console.log(modalImageAlt);
  
  modalWindow.classList.add('is-open');
  modalImage.src = modalImageSource;
  modalImage.alt = modalImageAlt;
}
